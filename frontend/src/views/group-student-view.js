  ...
  return (
    <>
      <Container>
        ...
        >
          <Box sx={style}>
            <Typography variant="h6" sx={{textAlign: "center"}}>Unesite podatke novog učenika</Typography>
            {alertVisible1 && (
            <Alert severity="error">
              Unesite ispravne podatke!
            </Alert>
             )}
            <TextField fullWidth label="Ime" id="name" sx={{marginTop: "2%", marginBottom: "2%"}} onChange={(e)=>setName(e.target.value)}/>
            <TextField fullWidth label="Prezime" id="surname" sx={{marginBottom: "2%"}} onChange={(e)=>setSurname(e.target.value)}/>
            <TextField fullWidth label="Email" id="email" sx={{marginBottom: "2%"}} onChange={(e)=>setEmail(e.target.value)}/>
            <TextField fullWidth label="Password" id="password" sx={{marginBottom: "2%"}} onChange={(e)=>setPassword(e.target.value)}/>
            <Button
            sx={{ display: "flex" }}
            size="small"
            variant="contained"
        ...
        >
          <Box sx={style}>
            <Typography variant="h6" sx={{textAlign: "center"}}>Unesite email učenika kojeg želite obrisati</Typography>
            {alertVisible && (
            <Alert severity="error">
              Unesite ispravan email!
            </Alert>
             )}
            <TextField fullWidth label="Email" id="emailDelete" sx={{marginTop: "5%", marginBottom: "5%"}} onChange={(e)=>setEmailDelete(e.target.value)}/>
            <Button
