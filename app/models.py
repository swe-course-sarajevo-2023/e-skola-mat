...
from sqlalchemy import Column, TIMESTAMP, DateTime, String, ForeignKey, Integer, Enum as SQLAlchemyEnum, func
...
class User(Base):
    ...
    role_id: Mapped[str] = mapped_column(UUID(as_uuid=False), ForeignKey('roles.id'), nullable=True)
